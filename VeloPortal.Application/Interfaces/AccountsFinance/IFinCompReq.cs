...
namespace VeloPortal.Application.Interfaces.AccountsFinance
{
    public interface IFinCompReq
    {
        ...
        Task<ApiResponse<DtoFinCompReqResponse>> ApproveAsync(DtoFinCompReqRequest request);
        Task<ApiResponse<DtoFinCompReqResponse>> CancelAsync(DtoFinCompReqRequest request);
